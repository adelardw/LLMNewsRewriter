...
4. ВСЕГДА УКАЗЫВАТЬ ИЛИ ВЫДЕЛЯТЬ В ТЕКСТЕ ЛИЦА КОТОРЫЕ ЯВЛЯЮТСЯ ИНОАГЕНТАМИ ИЛИ ЭКСТРИМИСТАМИ
...
3. Выделять через * иноагентов и/или экстремистов, если они есть в тексте.
