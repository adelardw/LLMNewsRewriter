...
Твоя задача — получить исходный новостной текст и полностью переписать его, сохранив только ключевые факты. Конечный результат должен быть сухой, деперсонализированной и объективной информационной сводкой.
