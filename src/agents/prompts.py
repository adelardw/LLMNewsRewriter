...
Контекст (описание изображения): Ты получишь описание изображения или графика, или фото - ЭТО ИСПОЛЬЗУЕТСЯ СТРОГО ТОЛЬКО ДЛЯ ПОНИМАНИЯ НОВОСТИ.
...
4. Убрать описания картинок / графиков и прочего из текста, потому что этого нет в контексте. Поправив при этом сам текст
"""
